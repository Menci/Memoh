/**
 * Custom FontAwesome icon definition for tavily search provider.
 * Registered with the 'fac' (custom) prefix and used as ['fac', 'tavily'].
 */
...
export const customSearchIcons = [facTavily]
